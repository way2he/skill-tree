# -*- coding: utf-8 -*-
"""
Mistral AI 官方 SDK 客户端

基于 mistralai SDK 实现，使用 API Key 鉴权。
...
class MistralOfficialClient(MistralClient):
    """
    Mistral AI 官方 SDK 客户端

    使用 mistralai.Mistral 进行模型调用。

    Args:
        api_key: API Key
        model: 模型名称，如 "mistral-medium", "mistral-large-latest"
        system_prompt: 系统提示词
    ...
    def _init_client(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                "mistralai 未安装，请运行: pip install mistralai"
            )
    ...
    def generate(self, prompt: str, **kwargs: Any) -> str:
        ...
        Example:
            >>> client = MistralOfficialClient(api_key="your-api-key")
