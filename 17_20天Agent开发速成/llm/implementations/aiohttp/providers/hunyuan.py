...
class HunyuanProvider(BaseAsyncProviderClient):
    """
    异步腾讯云混元大模型客户端（使用 OpenAI 兼容接口）
...
# 向后兼容别名
class AsyncHunyuanClient(HunyuanProvider):
    pass


# 向后兼容：原 OpenAI 兼容接口别名
class AsyncHunyuanOpenAIClient(HunyuanProvider):
    pass
