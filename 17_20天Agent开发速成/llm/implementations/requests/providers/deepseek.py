# -*- coding: utf-8 -*-
"""
深度求索 DeepSeek API 客户端

提供同步和异步方法调用 DeepSeek 模型，支持流式输出。
...
class DeepSeekProvider(BaseProviderClient):
    """
    DeepSeek API 客户端
    ...
    使用示例:
        client = DeepSeekProvider(api_key="your-api-key", model="deepseek-chat")
    ...
    Args:
        api_key: DeepSeek API 密钥，可通过环境变量 DEEPSEEK_API_KEY 设置
