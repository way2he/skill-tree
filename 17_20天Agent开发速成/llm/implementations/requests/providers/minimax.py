...
class MiniMaxProvider(BaseProviderClient):
    """
    MiniMax LLM 客户端
    API 文档: https://platform.minimaxi.com/document

    使用示例:
        client = MiniMaxProvider(api_key="your-api-key", model="abab6.5s-chat")
    ...
    Args:
        api_key: MiniMax API 密钥，可通过环境变量 MINIMAX_API_KEY 设置
        model: 模型名称，如 "abab6.5s-chat", "abab5.5s-chat"
    ...
    def __init__(
        ...
        Args:
            api_key: API 密钥，默认从环境变量 MINIMAX_API_KEY 读取
