# -*- coding: utf-8 -*-
"""
字节跳动豆包(Doubao) Provider

支持同步和异步 API 调用，使用 OpenAI 兼容接口。
"""
...
class DoubaoProvider(BaseProviderClient):
    """
    火山引擎豆包大模型 Provider
    ...
    # 类属性：默认模型
    DEFAULT_MODEL: str = "doubao-seed-2-0-code-preview-260215"
