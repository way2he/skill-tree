# -*- coding: utf-8 -*-
"""
X AI (Grok) OpenAI SDK 客户端
通过 OpenAI 兼容协议调用 X AI 的 Grok 系列模型
"""
...
class XAIClient(OpenAICompatibleClient):
    ...
    基于 OpenAI SDK 兼容协议，调用 X AI 提供的 Grok 系列大语言模型。
    ...
    def __init__(
        ...
        Args:
            api_key: API 密钥，若为 None 则从环境变量 XAI_API_KEY 读取
            model: 模型名称，默认使用 grok-2-1212
            base_url: API 基础地址，默认使用 https://api.x.ai/v1
            system_prompt: 系统提示词
