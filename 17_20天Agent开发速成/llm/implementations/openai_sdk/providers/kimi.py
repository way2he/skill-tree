...
class KimiClient(OpenAICompatibleClient):
    ...
    使用 Moonshot AI 官方 API，支持 moonshot-v1-8k、moonshot-v1-32k、moonshot-v1-128k 等模型。
    通过设置 MOONSHOT_API_KEY 环境变量或传入 api_key 参数进行认证。
    ...
    ENV_API_KEY: str = "MOONSHOT_API_KEY"
    ...
    def __init__(
        ...
        Args:
            api_key: API 密钥，若为 None 则从环境变量 MOONSHOT_API_KEY 获取
            model: 模型名称，默认为 moonshot-v1-8k
            base_url: API 基础地址，默认为 https://api.moonshot.cn/v1
            system_prompt: 系统提示词
