# -*- coding: utf-8 -*-
"""
Mistral AI OpenAI SDK 客户端
通过 OpenAI 兼容协议调用 Mistral AI 的系列模型
"""
...
class MistralClient(OpenAICompatibleClient):
    ...
    基于 OpenAI SDK 兼容协议，调用 Mistral AI 提供的大语言模型。
    ...
    def __init__(
        ...
        Args:
            api_key: API 密钥，若为 None 则从环境变量 MISTRAL_API_KEY 读取
            model: 模型名称，默认使用 mistral-large-latest
            base_url: API 基础地址，默认使用 https://api.mistral.ai/v1
            system_prompt: 系统提示词
