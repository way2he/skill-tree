...
class OpenAIClient(OpenAICompatibleClient):
    ...
    使用 OpenAI 官方 API，支持 GPT-4o、GPT-4 等模型。
    通过设置 OPENAI_API_KEY 环境变量或传入 api_key 参数进行认证。
    ...
    def __init__(
        ...
        Args:
            api_key: API 密钥，若为 None 则从环境变量 OPENAI_API_KEY 获取
            model: 模型名称，默认为 gpt-4o
            base_url: API 基础地址，默认为 https://api.openai.com/v1
            system_prompt: 系统提示词
