"""
LLM 统一接口层 - OpenAI 适配器
适配 openai/ 目录的 25 个厂商
"""
...
class OpenAILLMAdapter(BaseLLMAdapter):
    ...
    适配 openai/ 目录的 OpenAI SDK 兼容客户端
    """
    
    def __init__(self, inner_client: Any, provider_name: str = "openai"):
        """初始化 OpenAI 适配器
        
        Args:
            inner_client: 被适配的 OpenAI 客户端
            provider_name: 提供者名称
        """
