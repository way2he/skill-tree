"""
LLM 统一接口层 - Requests 适配器
适配 requests/ 目录的 25 个厂商
"""
...
class RequestsLLMAdapter(BaseLLMAdapter):
    """Requests LLM 适配器
    
    适配 requests/ 目录的同步客户端
    接口完全匹配，近乎透传
    """
    
    def __init__(self, inner_client: Any, provider_name: str = "requests"):
        """初始化 Requests 适配器
        
        Args:
            inner_client: 被适配的 requests 客户端
            provider_name: 提供者名称
        """
